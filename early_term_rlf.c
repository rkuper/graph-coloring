...
void early_update_nn(int color_number, int *nn_count, int nn[MAX_DIM]) {
  *nn_count = 0;
...
int early_find_suitable_y(int color_number, int *vertices_in_common, int *nn_count, int nn[MAX_DIM]) {
  int temp,tmp_y,y;
